...
tempUser.name = 'Bryan G. Smith'
tempUser.email = 'bryan.smith@devmounta.in'
...
let cat1 = new Cat('Yukki', 3, 'White')
...
let wizard1 = new Wizard('Gandolf', 2000000, 'You shall not pass!')
...
//Code Here
let phone1 = new Phone('Samsung', 'Note 10', 1, 'Blue', 1200)
...
//Code Here
let myFirstVehicle = new Vehicle(4, 'Black', 0)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'Black', 0, 'Victory', true)
...
//Code Here
let myFirstBoat = new Boat(8, 'Black', 1000, 'Black Pearl', 'Boat', false)
